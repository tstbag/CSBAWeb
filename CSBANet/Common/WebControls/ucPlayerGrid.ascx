...
<asp:Panel ID="pnlPlayer" runat="server" Width="50%">
    <h2>
        Manage Players  
    </h2>
                    ...
                    <FormTemplate>
                        <asp:Table ID="tblEnterAddress" runat="server" CellSpacing="2" CellPadding="1" BorderWidth="1px" Width="100%"
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell>
                                    <asp:Label ID="lblPlayerGUID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PlayerGUID") %>'>
                                    </asp:Label>
                                </asp:TableCell>
                            </asp:TableRow>
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="10%">
                                    <asp:Label ID="lblPlayerName" runat="server" Text="Player Name">
                                    </asp:Label>
                                </asp:TableCell>
                                <asp:TableCell>
